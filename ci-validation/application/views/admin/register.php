      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          foreach ($arr_gender as $gender) {
            ?>
            <label><input type="radio" id="rdo_male_gender" name="rdo_gender" value="<?=$gender?>"><?=$gender?></label>
            <?php
          }
          ?>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="txt_contact" name="txt_contact" placeholder="Enter Contact">
        </div>
        ...
        <div class="form-group">
          ...
          foreach ($arr_hobby as $hobby) {
            ?>
            <label><input type="checkbox" name="chk_hobby[]" value="<?=$hobby?>"><?=$hobby?></label>
            <?php
          }
          ?>
        </div>
